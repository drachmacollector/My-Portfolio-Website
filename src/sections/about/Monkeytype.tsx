            ...
            group bg-black/100">
              ...
              relative overflow-hidden">
                ...
                >
                  ...
                  transition-all duration-300 group-hover:text-blue-200/80">
                    {/* 15s with clock icon */}
                    <span className="flex items-center space-x-1">
                      <svg
                        ...
                        viewBox="0 0 256 256"
                        className="w-4 h-4 text-blue-300 transition-colors duration-300 group-hover:text-cyan-300"
                        fill="currentColor"
                      >
                  ...
                  {/* Subtle CTA */}
                  <div className="text-xs text-cyan-400/100 transition-all duration-300 
                  group-hover:text-cyan-200 group-hover:tracking-wide">
                    View on Monkeytype →
                  </div>
